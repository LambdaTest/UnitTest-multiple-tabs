# Handle Multiple Tabs in Python UnitTest with Selenium on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can open and switch between multiple browser tabs in your automation tests to simulate real-world multi-tab user flows. This sample shows how to configure multiple tabs handling in Python UnitTest on the TestMu AI cloud.
...
To open a new tab, use the following line of code:
...
To switch to the new tab, use the following line of code:
